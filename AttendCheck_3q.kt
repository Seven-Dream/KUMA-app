...
class AttendCheck_3q : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?){
        ...
        val at1 = readFiles("count3S1.txt")
        val ab1 = readFiles("count3K1.txt")
        val at2 = readFiles("count3S2.txt")
        val ab2 = readFiles("count3K2.txt")
        val at3 = readFiles("count3S3.txt")
        val ab3 = readFiles("count3K3.txt")
        val at4 = readFiles("count3S4.txt")
        val ab4 = readFiles("count3K4.txt")
        val at5 = readFiles("count3S5.txt")
        val ab5 = readFiles("count3K5.txt")
        val at6 = readFiles("count3S6.txt")
        val ab6 = readFiles("count3K6.txt")
        val at7 = readFiles("count3S7.txt")
        val ab7 = readFiles("count3K7.txt")
        val at8 = readFiles("count3S8.txt")
        val ab8 = readFiles("count3K8.txt")
        val at9 = readFiles("count3S9.txt")
        val ab9 = readFiles("count3K9.txt")
        val at10 = readFiles("count3S10.txt")
        val ab10 = readFiles("count3K10.txt")
        val at11 = readFiles("count3S11.txt")
        val ab11 = readFiles("count3K11.txt")
        val at12 = readFiles("count3S12.txt")
        val ab12 = readFiles("count3K12.txt")
        val at13 = readFiles("count3S13.txt")
        val ab13 = readFiles("count3K13.txt")
        val at14 = readFiles("count3S14.txt")
        val ab14 = readFiles("count3K14.txt")
        val at15 = readFiles("count3S15.txt")
        val ab15 = readFiles("count3K15.txt")
        val at16 = readFiles("count3S16.txt")
        val ab16 = readFiles("count3K16.txt")
        val at17 = readFiles("count3S17.txt")
        val ab17 = readFiles("count3K17.txt")
        val at18 = readFiles("count3S18.txt")
        val ab18 = readFiles("count3K18.txt")
        val at19 = readFiles("count3S19.txt")
        ...
        myListView.setOnItemClickListener { _, view, position, _ ->
            ...
            if (position != 0 && "$title" != "") {
                ...
                if (position == 0) {
                    val intent0 = Intent(application, Timetable_3q::class.java)
                    startActivity(intent0)
                } else if (position == 1) {
                    val intent1 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at1)
                    saveFile(fileNameK, ab1)
                    startActivity(intent1)
                } else if (position == 2) {
                    val intent2 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at2)
                    saveFile(fileNameK, ab2)
                    startActivity(intent2)
                } else if (position == 3) {
                    val intent3 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at3)
                    saveFile(fileNameK, ab3)
                    startActivity(intent3)
                } else if (position == 4) {
                    val intent4 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at4)
                    saveFile(fileNameK, ab4)
                    startActivity(intent4)
                } else if (position == 5) {
                    val intent5 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at5)
                    saveFile(fileNameK, ab5)
                    startActivity(intent5)
                } else if (position == 6) {
                    val intent6 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at6)
                    saveFile(fileNameK, ab6)
                    startActivity(intent6)
                } else if (position == 7) {
                    val intent7 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    ...
                    val intent10 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at10)
                    saveFile(fileNameK, ab10)
                    startActivity(intent10)
                } else if (position == 11) {
                    val intent11 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at11)
                    saveFile(fileNameK, ab11)
                    startActivity(intent11)
                } else if (position == 12) {
                    val intent12 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at12)
                    saveFile(fileNameK, ab12)
                    startActivity(intent12)
                } else if (position == 13) {
                    val intent13 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at13)
                    saveFile(fileNameK, ab13)
                    startActivity(intent13)
                } else if (position == 14) {
                    val intent14 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at14)
                    saveFile(fileNameK, ab14)
                    startActivity(intent14)
                } else if (position == 15) {
                    val intent15 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at15)
                    saveFile(fileNameK, ab15)
                    startActivity(intent15)
                } else if (position == 16) {
                    val intent16 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    saveFile(fileNameS, at16)
                    saveFile(fileNameK, ab16)
                    startActivity(intent16)
                } else if (position == 17) {
                    val intent17 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
                    ...
                    val intent20 = Intent(application, Count_3q::class.java)
                    saveFile(fileNameP, position)
