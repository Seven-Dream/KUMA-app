...
class Timetable_3q : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //月曜日の講義ID
        val mon1 = userDB.getLecture_id(2018,3,1,1)
        val mon2 = userDB.getLecture_id(2018,3,2,1)
        val mon3 = userDB.getLecture_id(2018,3,3,1)
        val mon4 = userDB.getLecture_id(2018,3,4,1)
        val mon5 = userDB.getLecture_id(2018,3,5,1)
        //火曜日の講義ID
        val tue1 = userDB.getLecture_id(2018,3,1,2)
        val tue2 = userDB.getLecture_id(2018,3,2,2)
        val tue3 = userDB.getLecture_id(2018,3,3,2)
        val tue4 = userDB.getLecture_id(2018,3,4,2)
        val tue5 = userDB.getLecture_id(2018,3,5,2)
        //水曜日の講義ID
        val wed1 = userDB.getLecture_id(2018,3,1,3)
        val wed2 = userDB.getLecture_id(2018,3,2,3)
        val wed3 = userDB.getLecture_id(2018,3,3,3)
        val wed4 = userDB.getLecture_id(2018,3,4,3)
        val wed5 = userDB.getLecture_id(2018,3,5,3)
        //木曜日の講義ID
        val thu1 = userDB.getLecture_id(2018,3,1,4)
        val thu2 = userDB.getLecture_id(2018,3,2,4)
        val thu3 = userDB.getLecture_id(2018,3,3,4)
        val thu4 = userDB.getLecture_id(2018,3,4,4)
        val thu5 = userDB.getLecture_id(2018,3,5,4)
        //金曜日の講義ID
        val fri1 = userDB.getLecture_id(2018,3,1,5)
        val fri2 = userDB.getLecture_id(2018,3,2,5)
        val fri3 = userDB.getLecture_id(2018,3,3,5)
        val fri4 = userDB.getLecture_id(2018,3,4,5)
        val fri5 = userDB.getLecture_id(2018,3,5,5)
