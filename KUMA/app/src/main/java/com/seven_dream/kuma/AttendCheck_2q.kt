...
class AttendCheck_2q : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val at1 = readFiles("count2S1.txt")
        val ab1 = readFiles("count2K1.txt")
        val at2 = readFiles("count2S2.txt")
        val ab2 = readFiles("count2K2.txt")
        val at3 = readFiles("count2S3.txt")
        val ab3 = readFiles("count2K3.txt")
        val at4 = readFiles("count2S4.txt")
        val ab4 = readFiles("count2K4.txt")
        val at5 = readFiles("count2S5.txt")
        val ab5 = readFiles("count2K5.txt")
        val at6 = readFiles("count2S6.txt")
        val ab6 = readFiles("count2K6.txt")
        val at7 = readFiles("count2S7.txt")
        val ab7 = readFiles("count2K7.txt")
        val at8 = readFiles("count2S8.txt")
        val ab8 = readFiles("count2K8.txt")
        val at9 = readFiles("count2S9.txt")
        val ab9 = readFiles("count2K9.txt")
        val at10 = readFiles("count2S10.txt")
        val ab10 = readFiles("count2K10.txt")
        val at11 = readFiles("count2S11.txt")
        val ab11 = readFiles("count2K11.txt")
        val at12 = readFiles("count2S12.txt")
        val ab12 = readFiles("count2K12.txt")
        val at13 = readFiles("count2S13.txt")
        val ab13 = readFiles("count2K13.txt")
        val at14 = readFiles("count2S14.txt")
        val ab14 = readFiles("count2K14.txt")
        val at15 = readFiles("count2S15.txt")
        val ab15 = readFiles("count2K15.txt")
        val at16 = readFiles("count2S16.txt")
        val ab16 = readFiles("count2K16.txt")
        val at17 = readFiles("count2S17.txt")
        val ab17 = readFiles("count2K17.txt")
        val at18 = readFiles("count2S18.txt")
        val ab18 = readFiles("count2K18.txt")
        val at19 = readFiles("count2S19.txt")
        val ab19 = readFiles("count2K19.txt")
        val at20 = readFiles("count2S20.txt")
        val ab20 = readFiles("count2K20.txt")
        val at21 = readFiles("count2S21.txt")
        val ab21 = readFiles("count2K21.txt")
        val at22 = readFiles("count2S22.txt")
        val ab22 = readFiles("count2K22.txt")
        val at23 = readFiles("count2S23.txt")
        val ab23 = readFiles("count2K23.txt")
        val at24 = readFiles("count2S24.txt")
        val ab24 = readFiles("count2K24.txt")
        val at25 = readFiles("count2S25.txt")
        val ab25 = readFiles("count2K25.txt")
        ...
        myListView.setOnItemClickListener { _, view, position, _ ->
            ...
            if (position == 0) {
                ...
                val intent1 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at1)
                saveFile(fileNameK, ab1)
                startActivity(intent1)
            } else if (position == 2) {
                val intent2 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at2)
                saveFile(fileNameK, ab2)
                startActivity(intent2)
            } else if (position == 3) {
                val intent3 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at3)
                saveFile(fileNameK, ab3)
                startActivity(intent3)
            } else if (position == 4) {
                val intent4 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at4)
                saveFile(fileNameK, ab4)
                startActivity(intent4)
            } else if (position == 5) {
                val intent5 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at5)
                saveFile(fileNameK, ab5)
                startActivity(intent5)
            } else if (position == 6) {
                val intent6 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at6)
                saveFile(fileNameK, ab6)
                startActivity(intent6)
            } else if (position == 7) {
                val intent7 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at7)
                saveFile(fileNameK, ab7)
                startActivity(intent7)
            } else if (position == 8) {
                val intent8 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at8)
                saveFile(fileNameK, ab8)
                startActivity(intent8)
            } else if (position == 9) {
                val intent9 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at9)
                saveFile(fileNameK, ab9)
                startActivity(intent9)
            } else if (position == 10) {
                val intent10 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at10)
                saveFile(fileNameK, ab10)
                startActivity(intent10)
            } else if (position == 11) {
                val intent11 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at11)
                saveFile(fileNameK, ab11)
                startActivity(intent11)
            } else if (position == 12) {
                val intent12 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at12)
                saveFile(fileNameK, ab12)
                startActivity(intent12)
            } else if (position == 13) {
                val intent13 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at13)
                saveFile(fileNameK, ab13)
                startActivity(intent13)
            } else if (position == 14) {
                val intent14 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at14)
                saveFile(fileNameK, ab14)
                startActivity(intent14)
            } else if (position == 15) {
                val intent15 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at15)
                saveFile(fileNameK, ab15)
                startActivity(intent15)
            } else if (position == 16) {
                val intent16 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at16)
                saveFile(fileNameK, ab16)
                startActivity(intent16)
            } else if (position == 17) {
                val intent17 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at17)
                saveFile(fileNameK, ab17)
                startActivity(intent17)
            } else if (position == 18) {
                val intent18 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at18)
                saveFile(fileNameK, ab18)
                startActivity(intent18)
            } else if (position == 19) {
                val intent19 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
                saveFile(fileNameS, at19)
                saveFile(fileNameK, ab19)
                startActivity(intent19)
            } else if (position == 20) {
                val intent20 = Intent(application, Count_2q::class.java)
                saveFile(fileNameP, position)
